...
public class ExecOld implements IComponentDeployer {
	...
	public ExecOld setUndeployCmd(String cmd) {
		this.undeployCmd = cmd;
		return this;
	}

	public ExecOld setDeployCmd(String cmd) {
		this.deployCmd = cmd;
		return this;
	}

	public ExecOld setStopExecutableName(String executable) {
		this.stopExecutableName = executable;
		return this;
	}

	public ExecOld setUndeployExecutableName(String executable) {
	...
	public String toString() {
		return "ExecOld{product=" + mainArtifact + '}';
	}
}
