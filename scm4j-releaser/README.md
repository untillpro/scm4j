...
Install groovy, download [run.grovy](https://raw.githubusercontent.com/scm4j/scm4j-wf/release/2/run.groovy) and execute `groovy run.groovy`, it will list available commands
