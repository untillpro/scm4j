...
Install groovy, download [run.grovy](https://raw.githubusercontent.com/scm4j/scm4j-releaser/release/8/run.groovy) and execute `groovy run.groovy`, it will list available commands
